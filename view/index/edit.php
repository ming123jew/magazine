...
<div class="wrap js-check-wrap">
		<div class="cf well form-search" style="margin-top:10px; height:35px;line-height:4px;">
		 ...
		 <form class="form-horizontal" action="" method="post">
		  ...
		  <input class="form-control text" type="hidden" id="thumb" name="info[thumb]" value="{$data.thumb}" placeholder="">
			...
			<div class="form-group ">
			    ...
			    <div class="col-lg-3">
			    <?php foreach ($array_catalogue as $key=>$value){?>
			     <input type="checkbox" name="info[catalogue][]" value="<?php echo $value['cid'].'|'.$value['name'];?>" {$value.checked}> <?php echo $value['name'];?>
			      &nbsp;&nbsp;&nbsp;&nbsp;
			    <?php }?>
			    &nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="form-group ">
			    ...
			    <div class="col-lg-3">
				     <input class="form-control text" type="text" name="info[title]" value="{$data.title}" placeholder="标题"> 
			    </div>
			</div>
			<div class="form-group ">
			    <label class="col-lg-2 control-label" for="signupform-username">关键词：</label>
			    <div class="col-lg-3">
				     <input class="form-control text" type="text" name="info[tags]" value="{$data.tags}" placeholder="关键词，注意用空格隔开."> 
			    </div>
			</div>
			<div class="form-group ">
			    <label class="col-lg-2 control-label" for="signupform-username">摘要：</label>
			    <div class="col-lg-3">
			   		 <textarea placeholder="摘要，请少于120字." class="form-control text" rows="" cols="" name="info[desc]">{$data.desc}</textarea>
			    </div>
			</div>
			<div class="form-group ">
			    ...
			    <div class="col-lg-3">
					...
					<div id="wrapper">
				        ...
				        <div class="cropper-wraper webuploader-element-invisible">
				            ...
				            <div class="img-preview" style="overflow: hidden;"><img src="{$data.thumb}" style="max-height: 200px;"/></div>
				        </div>
				    </div>
			...
			<div class="form-group ">
			    ...
			    <div class="col-lg-3">
			    	<input name="info[islink]" type="checkbox" id="islink" onclick="ruselinkurl();" <?php if($data['gourl']){?>checked<?php }?>>
			    	 <input class="form-control text" type="text" name="info[gourl]" id="gourl" value="{$data.gourl}" <?php if(!$data['gourl']){?>disabled="disabled"<?php }?> placeholder="跳转链接">  
			    </div>
			</div>
...
<script type="text/javascript">
var url_server = "<?php echo url('content/uploadthumb',['token'=>$token,'oldfile'=>urlencode($data['thumb']),'magazine_id'=>$id])?>";
//判断跳转
